...
const About = () => {
  return (
    <div className="  flex justify-center items-center px-72 py-11 " >
      <div>
        ...
        <div className="flex gap-12 mt-16 justify-center items-center">
        ...
        <div className="flex flex-row-reverse gap-12 mt-16 justify-center items-center">
          <div className="flex justify-center items-center gap-2">
            <img
          ...
          <div className="flex flex-col gap-3  max-w-[40%]">
            ...
            <div className="flex gap-6">
              <div>
                <div className="text-sm text-yellow-500">Monday  <span className="mx-1">—</span>  Thursday</div>
                <div className="text-sm">
                  8 am <span className="mx-1">—</span> 11 pm
                </div>
              </div>
              <div>
                <div className="text-sm text-yellow-500">Friday  <span className="mx-1">—</span>  Sunday</div>
                <div className="text-sm">
