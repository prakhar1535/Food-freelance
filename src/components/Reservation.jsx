...
const Reservation = () => {
  return (
    <div className=" bg-zinc-900 mt-16 overflow-hidden">
      <div className="flex align-center h-[70vh] overflow-hidden">
        <div className=" pl-[10%] h-full mt-[8%] flex-1">
          ...
          <form className=" w-4/6 mt-3">
            ...
            <div className="flex gap-6">
              ...
              <div>
                ...
                <input placeholder="Name" className="p-2 pl-4  w-full mb-2" />
              </div>
            </div>
          </form>
        </div>
